...
"""
LaTeX Delimiter and Environment Fix Utilities
=============================================

This module provides utilities for repairing and normalizing LaTeX math delimiters and environments
in Markdown or LaTeX text, especially for LLM-generated or user-provided content. It includes:

- Detection and correction of unbalanced, mismatched, or missing math delimiters ($, $$, \(, \), \[, \])
- Protection of code, comments, and verbatim regions from modification
- Heuristic detection of currency vs. math usage for dollar signs
- Conversion of \begin{align}...\end{align} to $$...$$ with \begin{aligned}...\end{aligned} for Markdown compatibility
- Detailed edit tracking for all changes made

Intended for use in applications that render or process Markdown/LaTeX content, such as chatbots, notebooks,
or document converters.
